    ...
    kotlin {
      ...
      sourceSets {
        ...
        val commonTest by getting {
          dependsOn(commonMain)
          dependencies {
            implementation("io.kotest:kotest-framework-engine:5.0.0.696-SNAPSHOT")
            implementation("org.jetbrains.kotlinx:kotlinx-coroutines-core:1.5.2")
            implementation("io.kotest:kotest-assertions-core:5.0.0.696-SNAPSHOT")
        ...
        val jvmTest by getting {
          ...
          dependsOn(jvmMain)
          dependencies {
            implementation("io.kotest:kotest-runner-junit5:5.0.0.696-SNAPSHOT")
          }
        }
      }
    }
