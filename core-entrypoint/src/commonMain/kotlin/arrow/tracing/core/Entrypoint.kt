...
public interface Entrypoint {
  ...
  public suspend fun <A> withRoot(name: String, trace: suspend (span: Span) -> A): A =
  ...
  ): A = continueWithChild(name, kernel).use(trace)
  ...
  public suspend fun <A> continueWithChildOrRoot(
    ...
    kernel: Kernel,
    trace: suspend (span: Span) -> A
  ): A = continueWithChildOrRoot(name, kernel).use(trace)
